...
func main() {
	...
	// for setting time server. See spec at ntp.org
	req[0] = 0x1B

	// response 48-byte long slice for incoming datagram with the
	// values from the server
	rsp := make([]byte, 48)

	// Create an address of type UDPAddr that represents the remote
	// host endpoint
	...
	// set up connection (net.UDPConn) with net.DialUDP()
